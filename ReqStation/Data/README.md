...
| RQSCODEFLT.csv | 143 | RQSCODEFLT (all five dropdown lists: 3 AREACODE, 16 AREATYPE, 65 NAMES, 6 AUTHBY, 53 BADGE - the complete employee tbl DeptID# 30/36 roster (badge # = employee #), from the 07/23/2026 export) |
