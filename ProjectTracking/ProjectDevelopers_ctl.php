...
function renderGroups() {
    ...
    // Other reads programmer by programmer, newest first inside each
    if (groups['Other']) {
        groups['Other'].sort(function (a, b) {
            return (a.pgmr < b.pgmr) ? -1 : (a.pgmr > b.pgmr) ? 1 :
                   (b.subraw || 0) - (a.subraw || 0) || (b.num - a.num);
        });
    }
