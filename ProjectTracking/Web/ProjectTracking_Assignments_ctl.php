<?php
/*    ***************************************************  -->
<!--  * Program Name - ProjectTracking_Assignments_ctl.php *  -->
<!--  *                                                 *  -->
<!--  * Author    -  G CHAU                             *  -->
...
if ($authorized != "yes") {
    ...
    include "ProjectTracking_Assignments_dsp.php";
    dspProjectTrackingAssignments();
?>
...
$(document).ready(function () {
    ...
    $('#chkComplete').on('change', loadAssignments);
