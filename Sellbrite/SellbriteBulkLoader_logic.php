...
final class Schema
{
    ...
    public static function optionsFor(array $col): array
    {
        ...
        if ($col['dropdown'] === 'store_category') {
            // Other Product Type only opens the non-coin sections; coin names live in coin_type
    ...
    {
        // category_name (Other Product Type) is not required - a regular coin leaves it blank
...
final class Computer
{
    ...
    // Des's record for this coin: Other Product Type, else coin type, else coin type + denomination
