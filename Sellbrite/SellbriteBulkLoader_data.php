 ...
 *
 *   'schema' - 85 column definitions (label / required / auto / dropdown key)
 *
 * The old 'values' (dropdown option lists) and 'lookups' (VLOOKUP auto-fill
 * data) sections were removed: coin facts now come from the GreySheet API via
 * the agent, so those fields are free-entry.  Reimplement from the .ods (git
 * history) if house-value constraints are ever needed again.
 */
return [
    'schema' => [
        [
